...
app.use(cors({ origin: [process.env.FRONTEND_URL, "https://lorepa.ca", "https://clownfish-app-aaokq.ondigitalocean.app", "https://lorepa-seven.vercel.app", "http://localhost:3000"], credentials: true }))
